...
class SearchControlClsTest {
    ...
    void setUp() {
        ...
        List<Flight> flightsTrip1 = new ArrayList<>(Arrays.asList(
                new Flight((short) 1, (short) 1, "one City", new Time(10, 10, 0)),
                new Flight((short) 2, (short) 2, "two City", new Time(9, 10, 0))
        ));
        List<City> citesAirTrip1 = new ArrayList<>(Arrays.asList(
                new City((short) 3, "three City"),
                new City((short) 4, "for City"),
                new City((short) 5, "five City")
        ));

        List<Flight> flightsTrip2 = new ArrayList<>(Arrays.asList(
                new Flight((short) 1, (short) 7, "seven City", new Time(10, 10, 0)),
                new Flight((short) 2, (short) 8, "eight Citi", new Time(9, 10, 0))
        ));

        List<City> citesAirTrip2 = new ArrayList<>(Arrays.asList(
        ...
        List<City> citesLandTrip1 = new ArrayList<>(Arrays.asList(
                new City((short) 1, "one City"),
                new City((short) 3, "three City"),
                new City((short) 7, "seven City")
        ));

        List<Hotel> hotelsLandTrip1 = new ArrayList<>(Arrays.asList(
        ...
        List<City> citesLandTrip2 = new ArrayList<>(Arrays.asList(
                new City((short) 5, "five City"),
                new City((short) 8, "eight City"),
                new City((short) 10, "ten City")
        ));
        List<Hotel> hotelsLandTrip2 = new ArrayList<>(Arrays.asList(
        ...
        List<City> citesLandTrip3 = new ArrayList<>(Arrays.asList(
                new City((short) 2, "two City"),
                new City((short) 4, "for City"),
                new City((short) 6, "six City")
        ));
        List<Hotel> hotelsLandTrip3 = new ArrayList<>(Arrays.asList(
    ...
    void resultConstruct() {
        ...
        SearchControlCls searchControlCls = SearchControlCls.getInstance();
